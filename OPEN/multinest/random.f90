...
! The following is code added from ranlib.f
! http://www.netlib.org/random/
! Compiled and Written by: Barry W. Brown, James Lovato

SUBROUTINE setgmnd(meanv,covm,p,parm)
!**********************************************************************
!            SET Generate Multivariate Normal random deviate
!
!                              Function
!
!      Places P, MEANV, and the Cholesky factoriztion of COVM in GENMN.
!
!                              Arguments
!
...
!
   ...
   50 CONTINUE
      RETURN
END SUBROUTINE setgmnd


SUBROUTINE genmnd(parm,x,work)
!**********************************************************************
